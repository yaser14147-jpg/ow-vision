...
class ClassicAHKUI:
    def __init__(self, root):
        ...
        self.root.geometry("340x520") # COMPACT: Reduced height from 630 to 520
        ...
        self.current_lang = "AR"; self.visualize_active = False; self.aimbot_running = False; self.app_version = "22.0"; self.process = None
