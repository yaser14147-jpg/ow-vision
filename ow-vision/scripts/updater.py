...
def main():
    print("==========================================")
    print("      [*] SUPREME COMPACT SYNC v21.0")
    print("==========================================")
    ...
    try:
        ...
        print(f"[!] SYNCING LATEST ELITE UI (Version: v{remote_ver})")
        ...
        print("\n[*] Initializing Environment Refresh...")
        ...
        print("\n[SUCCESS] Force-Sync v21.0 Finished.")
